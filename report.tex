...
The network architecture is structured as the following:
...
Trained models are available at: \href{https://drive.google.com/drive/folders/11P59rYOIyxDgdLGXGs8Tl7WMRHOJ-iar?usp=sharing}{Google Drive}.
...
\begin{table}[t]
  ...
  \begin{tabular}{lccccc}
    ...
    Top-10 NN         & 1.585 & 20.2\% & 37.9\% & 70.6\% & 88.7\% \\
    \bottomrule
  \end{tabular}
\end{table}
